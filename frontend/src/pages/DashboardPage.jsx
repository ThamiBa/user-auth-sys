  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        >
          <h3 className="text-xl font-semibold text-indigo-400 mb-3">Account Activity</h3>
      ...
      >
        <motion.button
          ...
          className="w-full py-3 px-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold rounded-lg
          shadow-lg hover:from-indigo-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-indigo-500
